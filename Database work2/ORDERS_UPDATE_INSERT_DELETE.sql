...
---TIME:12:AM
    ...
    CREATE OR ALTER PROCEDURE PCES_Orders_INSERT_UPDATE_DELETE
		...
		---I made these param null because i want to perform 'DELETE operation'
            (
	         @OrderId int OUTPUT,
             @UserId int=null,
    ...
    ELSE 
	   BEGIN
         INSERT INTO Orders 
		   ...
		   EXEC PCES_Orders_INSERT_UPDATE_DELETE @OrderId=12, @UserId=2, @Amount=399, @Fees=256.2,   @Total=670.3, @CreatedWhenUTC='5-DECEMBER 2022', @Description='Debt Payment been made', 
	                @Payer='Ken',@OrderStatusId=3, @CreatedBy='Frank',@CreatedDate='5-DECEMBER 2022',  @UpdatedBy='Kojo',
...
/*
		   ...
		   EXEC PCES_Orders_INSERT_UPDATE_DELETE @OrderId=12, @UserId=2, @Amount=399, @Fees=256.2,   @Total=670.3, @CreatedWhenUTC='5-DECEMBER 2022', @Description='Debt Payment been made', 
					...
					-- Update with null values
					 EXEC PCES_Orders_INSERT_UPDATE_DELETE @OrderId=11, @UserId=2, @Amount=101, @Fees=200.2,   @Total=300.3, @CreatedWhenUTC='5-DECEMBER 2022', @Description='Debt Payment been made', 
		    ...
		    EXEC PCES_Orders_INSERT_UPDATE_DELETE @OrderId=null, @UserId=1, @Amount=101, @Fees=200.2,   @Total=300.3, @CreatedWhenUTC='5-DECEMBER 2022', @Description='Debt Payment been made', 
	                ...
	                @UpdatedDate='23-December 2022',  @UpdatedDateUTC='6-December 2022',@Action=null
						...
						----This is DELETE  with the delete action type and  specified OrderId	 
                    	    EXEC PCES_Orders_INSERT_UPDATE_DELETE   @OrderId=10, @Action='DELETE'
